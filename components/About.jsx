...
export default function About() {
  return (
    <section className="bg-[#f5f4f1] py-14 text-[#6b625a]">
      <div className="mx-auto max-w-[1200px] px-6">
        <h2 className="text-center text-[24px] sm:text-[28px] md:text-[32px] font-semibold tracking-[0.14em] text-[#6b625a]">
        ...
        <div className="mt-10 grid items-center gap-10 lg:grid-cols-[0.58fr_0.42fr]">
          ...
          <div className="max-w-[420px]">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-[24px] sm:text-[26px] font-semibold tracking-[0.08em] text-[#6b625a]">
                GEETA SHARMA
              </h3>
            </div>

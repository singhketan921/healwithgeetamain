...
const STORE_KEYS = {
  ...
  workshops: Symbol.for("healwithgeeta.workshops"),
  music: Symbol.for("healwithgeeta.music"),
  spinwheel: Symbol.for("healwithgeeta.spinwheel"),
  blogs: Symbol.for("healwithgeeta.blogs"),
  products: Symbol.for("healwithgeeta.products"),
  testimonials: Symbol.for("healwithgeeta.testimonials"),
};

...
export default function VisitOurSacredPlace() {
  return (
    <section className="relative overflow-hidden bg-[#F9F4E8] px-6 py-12 sm:py-16">
      ...
      <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-[1fr_1.1fr]">
        <Reveal className="space-y-4 text-[#6b625a]">
